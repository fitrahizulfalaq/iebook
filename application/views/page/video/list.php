<div id="appCapsule">
    ...
    <div class="section mt-4">
        ...
        <div class="textArabic">
            <p align="right"><h1>مجموعة فيديوهات الخطابة العربية</h1></p>
            <p align="justify"> تتنـوع فنـون الخطابـة العربية وفقـاً&nbsp;لمـدى الاحتيـاج لهـا. فتتنـوع موضوعات الخطابـة العربية التي يلقيها الخطيب. فهذه هي بعض الأمثلة عن فيديوهات الخطابة العربية.</p>
        </div>
        <div class="goals">
            <!-- item -->
